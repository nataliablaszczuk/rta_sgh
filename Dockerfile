...
RUN pip install --no-cache-dir --upgrade pip setuptools wheel && \
    ...
    pip install --no-cache-dir ipywidgets flask==3.0.1 fastapi==0.115.5 uvicorn==0.32.0 pydot==2.0.0 && \
    pip install --no-cache-dir pennylane==0.39 && \ 
    pip install --no-cache-dir pandas==2.2.3 numpy==2.1.3 scipy==1.14.1 matplotlib==3.9.2 sympy==1.13.3 seaborn==0.13.2 && \
    pip install --no-cache-dir kafka-python3==3.0.0 confluent_kafka==2.6.0 && \
